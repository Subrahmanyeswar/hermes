...
REPORT_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "PARITY_ANALYSIS.md"))

CONTENT = """# Hermes Behavior Parity Analysis
...
def write_report():
    ...
    with open(REPORT_PATH, "w", encoding="utf-8") as f:
        f.write(CONTENT)
    print(f"Parity analysis report written to {REPORT_PATH}")
